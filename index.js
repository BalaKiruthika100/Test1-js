...
/*router.get('/employee/add',function(req,res){
    res.sendfile(path.join(NODEJS+'/front.html'));
});*/
...
app.delete('/employee/delete/:id',(req,res)=>{
    mysqlconnection.query('DELETE from balakiruthika WHERE id=?',[req.params.id],(err,rows,fields)=>{
        if(!err)
...
app.put('/employee/put',function(req,res){
